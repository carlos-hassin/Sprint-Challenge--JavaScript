...
const cuboidVolume = new CuboidMakerVolume({
  length: 4,
  width: 5,
  height: 5
})

const cuboidSurfaceArea = new CuboidMakerSurfaceArea({
  length: 4,
  width: 5,
  height: 5
})
...
console.log(cuboidVolume.volume()); // 100
console.log(cuboidSurfaceArea.surfaceArea()); // 130
